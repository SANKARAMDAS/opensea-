...
const style = {
    ...
    cardContainer: `rounded-[3rem] w-80 h-100`,
      ...
      <div className={style.container}>
        <div className={style.contentWrapper}>
          ...
          <div className={style.cardContainer}>
            <img
              className="rounded-t-lg w-80 h-100"
            ...
            <div className={style.infoContainer}>
              <img
                ...
                src="https://avatars.githubusercontent.com/u/31897843?v=4"
                alt=""
              />
              <div className={style.author}>
                <div className={style.name}>San.D</div>
                <a
